...
PHCrawler 是一款面向 Windows 的 Pornhub 专用图形化视频下载工具，支持 Pornhub 单个视频下载、列表批量处理、并发下载、失败重试及任务管理。
...
本工具仅用于处理你有权访问和下载的 Pornhub 内容。使用者应遵守 Pornhub 服务条款以及所在地法律法规，并自行承担使用责任。请勿将其用于侵权、绕过访问控制或其他未经授权的用途。本项目不隶属于 Pornhub，也未获得其官方认可或授权。
